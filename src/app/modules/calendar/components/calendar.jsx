...
export default function Calendar() {
	...
	return (
		<div className='background-color-white border-radius-large box-shadow-large width-100 centered max-width-14'>
			<header className='relative calendar-header border-color-grey clearfix'>
				...
				<a href='/next' onClick={nextOnClickHandler} className='calendar-next-month absolute right padding-horizontal no-decoration font-size-large padding-top-small color-dark-blue color-blue--on-hover font-weight-bold'>
			...
			<header className='padding-horizontal padding-top-medium'>
				<ul className='clearfix'>
					{dayNames.map(day => {
						return (
							<li key={day} className='day-header-item inline-block float-left font-weight-semi-bold padding-left-medium font-size-small color-dark-blue'>{day}</li>
						);
					})}
				</ul>
			</header>
